...
//                + ", StationCode=" + StationCode + ", StationPosition=" + StationPosition
//                + ", StationAddress=" + StationAddress + ", StationPhone="
...
//                + ", LocationCity=" + LocationCity +", LocationCityCode=" + LocationCityCode +", LocationTown=" + LocationTown
//                + ", LocationTownCode=" + LocationTownCode;
        return  StationPosition.toString() ;
